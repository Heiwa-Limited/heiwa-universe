...
pub trait register_agent {
    ...
    fn register_agent(&self, id: String) -> __sdk::Result<()> {
        self.register_agent_then(id, |_, _| {})
    }
...
impl register_agent for super::RemoteReducers {
    fn register_agent_then(
        ...
        self.imp
            .invoke_reducer_with_callback(RegisterAgentArgs { id }, callback)
    }
}
