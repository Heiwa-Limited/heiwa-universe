...
pub use sessions_table::*;
pub use submit_task_reducer::submit_task;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::SubmitTask { .. } => "submit_task",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            ...
            Reducer::RegisterAgent { id } => {
                __sats::bsatn::to_vec(&register_agent_reducer::RegisterAgentArgs { id: id.clone() })
            }
            Reducer::SubmitTask {
                session_id,
                objective,
            } => __sats::bsatn::to_vec(&submit_task_reducer::SubmitTaskArgs {
                session_id: session_id.clone(),
...
pub struct DbUpdate {
    ...
    sessions: __sdk::TableUpdate<Session>,
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "sessions" => db_update
                    .sessions
                    .append(sessions_table::parse_table_update(table_update)?),
                "tasks" => db_update
                    .tasks
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.messages = cache
            ...
            .with_updates_by_pk(|row| &row.id);
        diff.sessions = cache
            .apply_diff_to_table::<Session>("sessions", &self.sessions)
            .with_updates_by_pk(|row| &row.id);
        diff.tasks = cache
...
pub struct AppliedDiff<'r> {
    ...
    sessions: __sdk::TableAppliedDiff<'r, Session>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Session>("sessions", &self.sessions, event);
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    const ALL_TABLE_NAMES: &'static [&'static str] = &["agents", "messages", "sessions", "tasks"];
}
