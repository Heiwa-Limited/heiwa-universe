...
//!
//! Backend pivot 2026-07-15: Lance + GitHub replace SpacetimeDB. Journal
//! mechanics live in the shared [`heiwa_evidence`] crate — one evidence
//! service across core, orchestrator, and operator surfaces. This module
//! only maps the orchestrator's DREX types into persisted records.
...
pub use heiwa_evidence::{
    journal_root, read_stream, receipts_root, EvidenceEvent, EvidenceRuntime, EvidenceTransport,
    JsonlTransport, NoopTransport, PersistedArtifact, PersistedDispatchAck, PersistedDrexDecision,
    PersistedDrexFailure, PersistedRunFailure, PersistedRunReceipt, PersistedWorkerLease,
    PersistedWorkerSession, ReplayedStream, EVIDENCE_SCHEMA_VERSION,
};
