  ...
  return (
    <section>
      <div class="hero compact">
        ...
        <p class="lede">
          OAuth CLIs, API keys, and local runtimes under one cockpit. Maturity
          shown honestly by surface.
        </p>
      </div>
      <div class="panels">
          ...
          {(p) => (
            <article class="panel">
              <div class="status-card-head">
                <h2>{p.name}</h2>
                <span
                  class={`status-badge ${p.maturity === "stable" ? "ok" : p.maturity === "planned" ? "fail" : "warn"}`}
                >
