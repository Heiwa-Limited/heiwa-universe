  ...
  return (
    <section>
      <div class="hero compact">
        ...
        <p class="lede">
          Parent sessions own their children. Kill, attach, or inspect from the
          CLI or from here.
        </p>
      </div>
          ...
          <Show
            ...
            fallback={
              <div class="empty-state">
                ...
                <p class="muted">
                  Spawn one with <code>heiwa agent spawn</code>.
                </p>
              </div>
            }
          >
                  ...
                  <For each={data.agents}>
                    {(a) => (
                      <tr>
                        ...
                        <td>
                          <span
                            class={`status-badge ${a.status === "running" || a.status === "attached" ? "ok" : a.status === "killed" ? "fail" : "warn"}`}
                          >
                            {a.status}
                          </span>
                        </td>
