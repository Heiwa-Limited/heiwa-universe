...
*   **Routing**: Upon receiving user intent, it normalizes the request and routes it to the *most optimal starting model* defined in `config/swarm/ai_router.json`, effectively handing off the "steering wheel" to that model.
