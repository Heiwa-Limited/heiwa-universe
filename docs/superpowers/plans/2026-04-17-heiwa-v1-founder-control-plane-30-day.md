...
```bash
cd /Users/dmcgregsauce/heiwa-universe
rg -n "BFF|idle timeout|reauth threshold|machine enrollment|policy decision" docs/superpowers/specs/2026-04-17-heiwa-v1-founder-control-plane-design.md
```
...
```bash
git add docs/superpowers/specs/2026-04-17-heiwa-v1-founder-control-plane-design.md docs/superpowers/plans/2026-04-17-heiwa-v1-founder-control-plane-30-day.md
