...
pub struct RunRecordCols {
    ...
    pub session_id: __sdk::__query_builder::Col<RunRecord, Option<String>>,
    ...
    pub failure_code: __sdk::__query_builder::Col<RunRecord, Option<String>>,
    pub failure_message: __sdk::__query_builder::Col<RunRecord, Option<String>>,
}
...
pub struct RunRecordIxCols {
    ...
    pub session_id: __sdk::__query_builder::IxCol<RunRecord, Option<String>>,
