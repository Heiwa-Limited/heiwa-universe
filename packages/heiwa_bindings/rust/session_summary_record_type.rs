...
/// Column accessor struct for the table `SessionSummaryRecord`.
///
...
impl __sdk::__query_builder::HasCols for SessionSummaryRecord {
    type Cols = SessionSummaryRecordCols;
...
/// Indexed column accessor struct for the table `SessionSummaryRecord`.
///
...
impl __sdk::__query_builder::HasIxCols for SessionSummaryRecord {
    type IxCols = SessionSummaryRecordIxCols;
...
impl __sdk::__query_builder::CanBeLookupTable for SessionSummaryRecord {}
